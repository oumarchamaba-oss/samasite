...
export const SECTEURS = [
  ...
  // Secteurs ajoutés le 21/09/2026 — auparavant absents de la liste, ce qui
  // obligeait ces activités à choisir un secteur approximatif et donc à
  // hériter d'exemples hors sujet (voir demande du 21/09/2026, point 1).
  {
    id: "agriculture",
    couleurBadge: "#4D7C3A",
    label: "Agriculture & Élevage",
    description: "Présentez vos produits agricoles et vos récoltes, et recevez vos commandes directement sur WhatsApp.",
    icon: Wheat,
    type: "catalogue",
    libelleCatalogue: "Nos produits",
    libelleAction: "Commander",
    ...
    demo: {
      nom: "Ferme Teranga",
      accroche: "Des récoltes fraîches, du champ à votre table",
      produits: [
        { texte: "Sac de riz local 25 kg", prix: "15 000 F", categorie: "Céréales" },
        { texte: "Cageot de tomates fraîches", prix: "5 000 F", categorie: "Légumes" },
        { texte: "Régime de bananes plantain", prix: "3 500 F", categorie: "Fruits" },
        { texte: "Poulet fermier élevé au sol", prix: "4 500 F", categorie: "Élevage" },
      ],
    },
  },
  {
    ...
    description: "Présentez vos appareils avec prix, garantie et disponibilité, et recevez vos commandes directement sur WhatsApp.",
    icon: Zap,
    type: "catalogue",
    libelleCatalogue: "Nos appareils",
    libelleAction: "Commander",
    modesLivraison: ["retrait", "livraison"],
    demo: {
      nom: "TechStore Dakar",
      accroche: "Des appareils fiables, garantis, livrés chez vous",
      produits: [
        { texte: "Smartphone Android 128 Go", prix: "95 000 F", categorie: "Téléphones" },
        { texte: "Téléviseur LED 43 pouces", prix: "180 000 F", categorie: "TV & Image" },
        { texte: "Ventilateur sur pied", prix: "22 000 F", categorie: "Électroménager" },
        { texte: "Chargeur solaire portable", prix: "12 000 F", categorie: "Accessoires" },
      ],
    },
  },
];
...
export const SECTEUR_COULEURS = {
  ...
  // Palettes ajoutées le 21/09/2026 avec les secteurs "agriculture" et
  // "electronique" — voir demande du 21/09/2026, point 1.
  agriculture: [
    { id: "vertchamp", name: "Vert Champ", hex: "#4D7C3A" },
    { id: "vertolive", name: "Vert Olive", hex: "#6B8E23" },
    { id: "terrecuite", name: "Terre Cuite", hex: "#A0522D" },
    { id: "brunterreau", name: "Brun Terreau", hex: "#6F4E28" },
    { id: "doreble", name: "Doré Blé", hex: "#D4A017" },
    { id: "jaunemais", name: "Jaune Maïs", hex: "#E8B923" },
    { id: "orangerecolte", name: "Orange Récolte", hex: "#D2691E" },
    { id: "rougetomatechamp", name: "Rouge Tomate", hex: "#B33A2A" },
    { id: "vertfeuille", name: "Vert Feuille", hex: "#3F7D3A" },
    { id: "beigesableagri", name: "Beige Sable", hex: "#C9A876" },
    { id: "marroncafeagri", name: "Marron Café", hex: "#5C3A21" },
    { id: "vertmenthesauvage", name: "Vert Menthe Sauvage", hex: "#7FA65A" },
    { id: "ocreagri", name: "Ocre", hex: "#C08A2E" },
    { id: "vertforet", name: "Vert Forêt", hex: "#2E5732" },
    { id: "rougebriqueagri", name: "Rouge Brique", hex: "#9C4A2B" },
    { id: "jaunepaille", name: "Jaune Paille", hex: "#D9B44A" },
    { id: "vertkaki", name: "Vert Kaki", hex: "#7A8B5A" },
    { id: "brunchocolatagri", name: "Brun Chocolat", hex: "#4A2E1E" },
  ],
  electronique: [
    { id: "bleutech", name: "Bleu Tech", hex: "#2563EB" },
    { id: "bleunuittech", name: "Bleu Nuit", hex: "#1E3A8A" },
    { id: "grismetal", name: "Gris Métal", hex: "#64748B" },
    { id: "grisacier", name: "Gris Acier", hex: "#4B5563" },
    { id: "noircarbone", name: "Noir Carbone", hex: "#1F2937" },
    { id: "cyandigital", name: "Cyan Digital", hex: "#06B6D4" },
    { id: "bleuelectrique", name: "Bleu Électrique", hex: "#1D4ED8" },
    { id: "violetcircuit", name: "Violet Circuit", hex: "#6D28D9" },
    { id: "grisargent", name: "Gris Argent", hex: "#94A3B8" },
    { id: "bleucieltech", name: "Bleu Ciel Tech", hex: "#38BDF8" },
    { id: "vertsignal", name: "Vert Signal", hex: "#16A34A" },
    { id: "rougealerte", name: "Rouge Alerte", hex: "#DC2626" },
    { id: "orangebatterie", name: "Orange Batterie", hex: "#F59E0B" },
    { id: "bleumarinetech", name: "Bleu Marine", hex: "#0F2A5C" },
    { id: "grisanthracitetech", name: "Gris Anthracite", hex: "#374151" },
    { id: "turquoisetech", name: "Turquoise", hex: "#0D9488" },
    { id: "indigotech", name: "Indigo", hex: "#4338CA" },
    { id: "grisardoisetech", name: "Gris Ardoise", hex: "#334155" },
  ],
};
...
export const FAQ = [
  ...
  {
    q: "Mes clients peuvent-ils payer directement sur mon site (Orange Money, Wave, carte bancaire) ?",
    r: "Oui. En plus de la commande WhatsApp, vous pouvez activer le paiement en ligne (Orange Money, Wave, Free Money, Visa, Mastercard) — inclus dans le prix de votre site, sans frais supplémentaire. L'argent va directement sur votre propre compte marchand, jamais via Sama Site. Il suffit de cocher l'option à la création (ou depuis votre espace) ; notre équipe l'active dès que votre site est payé et livré.",
  },
  {
