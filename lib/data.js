...
export const CLIENTS_CONFIANCE = [
  ...
  { nom: "JOOR Garage", secteur: "Artisanat & Réparation", icon: Settings2, domaine: "joorgarage.com" },
  { nom: "FRAISEN", secteur: "Produits du terroir", icon: ShoppingBasket, domaine: "fraisen.com" },
