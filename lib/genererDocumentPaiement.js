import { SECTEURS, DOMAINES, DUREES, PAIEMENTS } from "./data";
...
<body>
  <div class="entete">
    <div class="marque">Sama Site<small>Dakar, Sénégal — samasite.com</small></div>
    <div class="titre-doc">
      <h1>${titre}</h1>
      <p>Réf. ${refDoc} · ${date}</p>
    </div>
  ...
  <div class="infos">
    <div class="bloc">
      <h3>Émis par</h3>
      <p><strong>Sama Site</strong><br>Dakar, Sénégal<br>contact@samasite.com</p>
    </div>
    <div class="bloc">
      <h3>Client</h3>
